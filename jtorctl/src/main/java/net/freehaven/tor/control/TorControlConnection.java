...
public class TorControlConnection implements TorControlCommands {
    ...
    */
    ...
    /**
     * Tells Tor to generate and set up a new v3 onion service.
     * <p/>
     * ADD_ONION was added in Tor 0.2.7.1-alpha.
     */
    public Map<String,String> addOnionV3(Map<Integer,String> portLines)
            throws IOException {
        return addOnion("NEW:ED25519-V3", portLines, null);
    }
